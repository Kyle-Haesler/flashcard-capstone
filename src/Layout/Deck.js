...
import { readDeck, deleteDeck, deleteCard, createCard } from "../utils/api";
...
function Deck() {
  ...
  // initializing formstate and associated form functions here to pass down to AddCard
  ...
  // handle change for AddCard form
  const handleChange = ({ target }) => {
    setFormData({ ...formData, [target.name]: target.value });
  };

  // handle submit event for AddCard form
